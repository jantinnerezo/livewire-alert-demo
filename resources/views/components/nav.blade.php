<div class="flex items-center justify-end">
    <a href="https://github.com/jantinnerezo/livewire-alert" rel="noopener" target="_blank" class="flex items-center px-4 py-3 font-medium text-cool-gray-600 transition-all hover:opacity-50">
        Github
